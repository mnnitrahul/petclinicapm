...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    try:
        ...
        try:
            ...
            debug_info["diagnosis"].append("✅ Built-in Python libraries available (no external deps needed)")
        ...
        debug_info["connection_test"]["method"] = "pure_python_rest_api"
        debug_info["diagnosis"].append("✅ Using pure Python REST API (no external deps)")
